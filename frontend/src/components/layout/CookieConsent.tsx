...
export function CookieConsent() {
 ...
 className="p-2 hover:bg-sand-100 :bg-sand-200 rounded-full transition-colors text-navy-950 hover:text-navy-950 "
 >
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 className="flex-grow bg-sand-50 text-navy-950 border border-sand-200 px-6 py-4 rounded-2xl font-bold text-sm hover:bg-sand-100 :bg-sand-200 transition-all flex items-center justify-center gap-2"
 >
 Essential Only
 </button>
 </div>
