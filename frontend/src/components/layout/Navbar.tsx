...
export function Navbar() {
 ...
 const useDarkText = isScrolled || isDashboard; return (<motion.nav initial={{ y: 0 }} animate={{ y: isVisible ? 0 : -100 }} transition={{ duration: 0.3, ease: "easeInOut" }} className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-700 ease-[0.16,1,0.3,1]", isScrolled ? "bg-sand-50 backdrop-blur-2xl border-b border-sand-200 shadow-sm py-2 md:py-1.5" : isDashboard ? "bg-transparent py-4 md:py-[1.15rem]" : "bg-navy-950/60 backdrop-blur-xl border-b border-white/5 shadow-sm py-4 md:py-[1.15rem]")}>
