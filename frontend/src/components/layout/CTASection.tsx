          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link to="/contact" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full border-white/20 text-white hover:bg-white  hover:border-gold-400/40 transition-all duration-500 rounded-full px-10 h-14 text-lg font-bold">
                  Contact Concierge
                </Button>
              </Link>
            </div>
