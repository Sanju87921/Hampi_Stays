...
export function LanguageSwitcher({ className }: LanguageSwitcherProps) {
 ...
 className="flex items-center gap-2 px-3 py-2 rounded-full hover:bg-sand-100 :bg-sand-200/50 transition-colors border border-transparent hover:border-sand-200 "
 >
