...
export function PremiumIcon({
  ...
  const variants = {
    ...
    glass: {
      container: "bg-white  backdrop-blur-xl border border-white/40 shadow-[0_10px_20px_-5px_rgba(0,0,0,0.1),inset_0_-4px_8px_rgba(255,255,255,0.2),inset_0_4px_8px_rgba(255,255,255,0.5)]",
      icon: "text-navy-950  drop-shadow-[0_2px_3px_rgba(0,0,0,0.1)]",
      glow: "bg-white "
    }
  };
