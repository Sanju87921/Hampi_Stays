      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {collections.map((collection) => (
          <div 
            ...
            className="group cursor-pointer bg-white/5 border border-white/10 p-6 rounded-3xl hover:bg-white/10 hover:border-[#C5A059]/30 transition-all text-center flex flex-col items-center justify-center backdrop-blur-md"
          >
