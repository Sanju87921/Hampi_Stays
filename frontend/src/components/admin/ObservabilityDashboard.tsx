...
const MetricCard = ({ title, value, status, icon: Icon, trend }: any) => (
  <div className="bg-white/5 border border-[#C5A059]/20 p-6 rounded-2xl backdrop-blur-md">
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 bg-[#0A1128] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <div className="bg-white/5 border border-[#C5A059]/20 p-8 rounded-3xl">
        ...
        <div className="bg-white/5 border border-red-500/20 p-8 rounded-3xl relative overflow-hidden">
