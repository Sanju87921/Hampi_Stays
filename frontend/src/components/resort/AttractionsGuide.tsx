        ...
        {attractions.map((place) => (
          ...
          >
            ...
            <div className="flex-grow">
              ...
              <p className="text-xs text-navy-950   line-clamp-2 leading-relaxed">
                Discover the architectural marvels of the Vijayanagara Empire located just a short journey from your sanctuary.
              </p>
            </div>
            <ArrowRight className="w-4 h-4 text-navy-950   group-hover:text-gold-600 transition-all group-hover:translate-x-1" />
          </div>
        ))}
      </div>
