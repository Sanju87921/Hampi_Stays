...
export function SearchBar() {
 ...
 type="button"
 onClick={() => setLocation("")}
 className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 hover:bg-sand-100 :bg-sand-200 rounded-full text-navy-950 hover:text-navy-950 transition-colors"
 >
 ...
 className="w-full text-left flex items-center gap-4 px-4 py-3.5 rounded-2xl hover:bg-sand-50 :bg-sand-100 transition-all group"
 >
