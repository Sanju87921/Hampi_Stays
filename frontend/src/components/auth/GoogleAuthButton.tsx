...
export function GoogleAuthButton({ onSuccess, isLoading, text = "Slide to Continue" }: GoogleAuthButtonProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main Track */}
      <div className={cn(
        "relative w-full h-[60px] bg-sand-100  backdrop-blur-md border border-sand-200  rounded-3xl overflow-hidden transition-all duration-500",
        ...
        <motion.div
          ...
          className={cn(
            ...
            isSuccess ? "bg-gold-500 shadow-gold" : "bg-white  shadow-premium border border-sand-100  hover:bg-sand-50 :bg-zinc-800"
          )}
        >
