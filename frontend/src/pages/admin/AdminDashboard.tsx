      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white  rounded-[2.5rem] border border-sand-200  shadow-sm p-8">
          ...
          <div className="space-y-6">
            {[1, 2, 3].map((_, i) => (
              <div key={i} className="flex items-center gap-4 p-4 hover:bg-sand-50 :bg-zinc-800 rounded-2xl transition-colors">
              ...
              <div className="relative z-10">
                ...
                <div className="flex gap-4">
                  <Button 
                    variant="outline" 
                    onClick={() => setShowConfirmModal(false)}
                    className="flex-1 h-14 rounded-2xl border-sand-200  text-navy-950  hover:bg-sand-50 :bg-zinc-800"
                  >
                    Cancel
                  </Button>
                  <Button 
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-sand-100">
            {(allUsers || []).map((user) => (
              <tr key={user.id} className="hover:bg-sand-50 :bg-zinc-800/30 transition-colors">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-sand-100">
            {allBookings.map((booking) => (
              <tr key={booking.id} className="hover:bg-sand-50 :bg-zinc-800/30 transition-colors">
                <td className="px-8 py-6">
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-sand-100">
              {pendingPayouts.map((payout) => (
                <tr key={payout.id} className="hover:bg-sand-50 :bg-zinc-800/30 transition-colors">
      ...
      <div className="bg-white  rounded-[2.5rem] p-8 border border-sand-200  shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-sand-100">
              {otpLogs.map((log) => (
                <tr key={log.id} className={`hover:bg-sand-50 :bg-zinc-800/30 transition-colors ${
      ...
      <div className="bg-white  rounded-[2.5rem] p-10 border border-sand-200  shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-4">
          {activeResorts.map(resort => (
            <div key={resort.id} className="p-6 rounded-2xl border border-sand-100  bg-sand-50  flex items-center justify-between hover:bg-sand-50 :bg-zinc-800 transition-colors">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${
                  activeTab === tab.id 
                    ...
                    : "text-navy-950   hover:text-navy-950  hover:bg-sand-50 :bg-zinc-800"
                }`}
              >
