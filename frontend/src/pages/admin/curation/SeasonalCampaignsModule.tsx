    ...
    return (
      <div className="bg-sand-50/50 p-6 rounded-2xl border border-sand-200">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Title</label>
          ...
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Subtitle</label>
          ...
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Banner URL</label>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="text-xs font-bold text-navy-950/60 uppercase">Priority (Higher is first)</label>
        ...
        {campaigns.map(camp => (
          <div key={camp.id} className="bg-white rounded-2xl border border-sand-200 overflow-hidden flex flex-col">
            ...
            <div className="p-5 flex-1">
              ...
              <p className="text-sm text-navy-950/60 mb-4">{camp.subtitle}</p>
              <div className="flex items-center gap-2 text-xs font-bold text-navy-950/40 uppercase mb-4">
