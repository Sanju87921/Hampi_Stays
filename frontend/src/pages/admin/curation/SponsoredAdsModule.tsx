    ...
    return (
      <div className="bg-sand-50  p-6 rounded-2xl border border-sand-200 ">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            <label className="text-xs font-bold text-navy-950   uppercase">Resort ID (Must exist)</label>
          ...
          <div>
            <label className="text-xs font-bold text-navy-950   uppercase">Placement Strategy</label>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="text-xs font-bold text-navy-950   uppercase">Priority Index</label>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-gold-50 p-6 rounded-2xl border border-gold-200">
        <div>
          ...
          <p className="text-sm text-navy-950  ">Boost visibility for partner resorts across the platform.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {ads.map(ad => (
          <div key={ad.id} className="bg-white  rounded-2xl border border-sand-200  p-5 flex flex-col relative overflow-hidden">
            ...
            <p className="text-sm text-navy-950   mb-2">Priority: {ad.priority}</p>
            <p className="text-xs text-navy-950   mb-6 font-mono">
