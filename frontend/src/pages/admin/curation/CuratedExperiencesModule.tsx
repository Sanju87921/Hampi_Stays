    ...
    return (
      <div className="bg-sand-50/50 p-6 rounded-2xl border border-sand-200">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Experience Title</label>
          ...
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Description</label>
          ...
          <div>
            <label className="text-xs font-bold text-navy-950/60 uppercase">Image URL</label>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-bold text-navy-950/60 uppercase">Price (₹)</label>
            ...
            <div>
              <label className="text-xs font-bold text-navy-950/60 uppercase">Duration (e.g., 2 Hours)</label>
            ...
            <div>
              <label className="text-xs font-bold text-navy-950/60 uppercase">Location</label>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-navy-950/60">Manage heritage walks, coracle rides, and tours.</p>
        </div>
        ...
        {experiences.map(exp => (
          <div key={exp.id} className="bg-white rounded-2xl border border-sand-200 overflow-hidden flex flex-col group">
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6 bg-sand-50/50 p-3 rounded-xl">
