          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                return (
                  <div key={i} className="flex items-center justify-between p-4 border border-sand-100  rounded-xl hover:bg-sand-50 :bg-zinc-800/50 transition-colors">
                    <div>
                ...
                <button 
                  ...
                  className={`flex items-center px-4 py-2 text-sm font-bold rounded-lg transition-colors disabled:opacity-50 ${
                    settings?.detailedAuditLogging 
                      ...
                      : 'bg-sand-200  text-navy-950  hover:bg-sand-300 :bg-zinc-700'
                  }`}
                >
