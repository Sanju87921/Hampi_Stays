          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div className="bg-sand-50  rounded-2xl border border-sand-200  overflow-hidden">
              ...
              <div className="p-5">
                ...
                <button className="w-full py-2 border border-sand-300 rounded-xl text-xs font-bold text-navy-950  hover:bg-sand-100 :bg-zinc-700 transition-colors">Replace Resort</button>
              </div>
            </div>
            <div className="bg-sand-50  rounded-2xl border border-sand-200  overflow-hidden">
              <div className="h-40 bg-sand-200  relative">
            ...
            <div className="bg-sand-50  rounded-2xl border-2 border-dashed border-sand-200  flex flex-col items-center justify-center p-6 h-[280px] hover:bg-sand-50 :bg-zinc-800 transition-colors cursor-pointer group">
              ...
              <div className="p-3 flex flex-col gap-1">
                {tabs.map(tab => (
                  <button key={tab.id} onClick={() => setActiveTab(tab.id)}
                    className={`flex items-center gap-3 w-full px-4 py-3.5 rounded-2xl transition-all duration-300 font-semibold text-sm ${activeTab === tab.id ? 'bg-navy-950 text-white shadow-md' : 'text-navy-950   hover:bg-sand-50 :bg-zinc-800 hover:text-navy-950 '}`}>
