                  ...
                  sessions.map((session, i) => (
                    <div key={i} className="flex items-center justify-between p-4 bg-sand-50 rounded-xl">
                      <div>
                        ...
                        <p className="text-xs text-navy-950/50 mt-1">IP: {session.ipAddress}</p>
                      </div>
                      <div className="flex flex-col items-end">
                        <p className="text-xs font-semibold text-navy-950/60 mb-2">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-navy-950/40 backdrop-blur-sm">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setShowPasswordModal(false)} className="text-navy-950/50 hover:text-navy-950 transition-colors">
                  <X className="w-6 h-6" />
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-navy-950/40 backdrop-blur-sm">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setShowMfaModal(false)} className="text-navy-950/50 hover:text-navy-950 transition-colors">
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              {isSettingUpMfa ? (
                <div className="flex flex-col items-center justify-center py-10">
                  ...
                  <p className="text-sm font-medium text-navy-950/60">Generating secure credentials...</p>
                </div>
              ) : mfaData ? (
                <div className="text-center">
                  <p className="text-sm font-medium text-navy-950/70 mb-4">
